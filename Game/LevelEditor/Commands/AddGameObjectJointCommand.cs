...
{
    public class AddGameObjectJointCommand : ICommand, IUndoRedoCommand
    {
        ...
        public AddGameObjectJointCommand(GameObject gameObject, Joint joint)
        {
