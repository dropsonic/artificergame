...
{
    public class RemoveObjectPartCommand : ICommand, IUndoRedoCommand
    {
        ...
        public RemoveObjectPartCommand(GameObject objectToAdd, GameObject goalObject, Vector2 position)
        {
